...
const REQUIRED_SHEETS = [
  ...
  { name: 'Planejamentos', headers: ['ID', 'ID_Projeto', 'Nome_Projeto', 'Cliente', 'Nr_Contrato_OS', 'Resp_Planejamento', 'Resp_Aprovacao', 'Setor', 'Tipologia', 'Empresa', 'Link_ClickUp', 'Valor_Contrato', 'Impostos_Perc', 'Taxa_Adm_Perc', 'Comissao_Perc', 'Data_Inicio_OS', 'Data_Entrega_Contrato', 'Data_Entrega_Planejada', 'Status', 'Justificativa', 'Comentario_Aprovacao', 'Justificativa_Replanejamento', 'Snapshot_Anterior', 'Criado_Por', 'Criado_Em', 'Aprovado_Por', 'Aprovado_Em', 'Dados_JSON'] },
